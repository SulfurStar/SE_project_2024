<template>
  <div class="delete-account-container">
    <h1 class="page-title">選擇學生修改訪視紀錄</h1>
          ...
          <ul>
            <el-scrollbar height="400px">
              <li v-for="student in students" :key=student.id>
                <VisitationTitleRecordCard :student="student" />
              </li>
            </el-scrollbar>
          </ul>
      </div>
...
import VisitationTitleRecordCard from "~/components/VisitationTitleRecordCard.vue";
